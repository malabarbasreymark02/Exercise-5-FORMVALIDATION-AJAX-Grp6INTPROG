...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['submit'])) { // Login Form
        ...
        if (empty($name) || strlen($name) < 2) {
            ...
            // Prepare SQL statement using MySQLi for the comments
...
<a href="#" class="title">
    <h3>
    <?php
    // Only display the username if it was submitted without errors
    if (isset($_POST["username"]) && !empty($_POST["username"]) && empty($usernameError)) {
        echo htmlspecialchars($_POST["username"]); // Display the name safely
    } else {
   ...
   <!-- <ul class="navbar">
    <li><a href="#home">Home</a></li>
    <li><a href="#members">Members</a></li>
    <li class="hidden"><a href="#profile" id="show-profile">Profile</a></li>
    <li class="hidden"><a href="#others" id="show-others">Others</a></li>
    <li class="hidden"><a href="#rate" id="rate">Comment</a></li>
    <li><a href="#login" id="login">Login</a></li>
</ul>-->
